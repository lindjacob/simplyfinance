...
function Banner({ editing, setEditing, prevBudgets, setBudgets }: BannerProps) {
  ...
  return (
    ...
    >
      <p className="text-lg text-white p-2">
        You have started to plan your finances. When you are done, either save
        or discard your changes:
      </p>
      <div>
        <button className="bg-white m-2 p-1 rounded-md" onClick={handleDiscard}>
          Discard
        </button>
        <button className="bg-white m-2 p-1 rounded-md" onClick={handleSave}>
          Save
        </button>
      </div>
    </div>
